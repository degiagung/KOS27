...
function getListData() {
    dtpr = $("#table-list").DataTable({
        ...
        buttons: [
            ...
            { text: ' ', extend: 'pdfHtml5',  className: 'btndownload iconpdf',  title:'List Tipe Kamar', exportOptions: {columns:[':not(.notdown)']}},
            { text: ' ', extend: 'excel',  className: 'btndownload iconexcel',  title:'List Tipe Kamar', exportOptions: {columns:[':not(.notdown)']}},
        ],
        columns: [
            {
