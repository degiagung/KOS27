...
@section('content')
    ...
    @elseif ($role == 'penghuni')
        @include('pages.dashboard.dashboardpenghuni');
    @elseif ($role == 'penjaga')
        @include('pages.admin.property.listkamar');
    @elseif ($role == 'pemilik')
        @include('pages.dashboard.dashboardpemilik');
    @endif
@endsection
...
@foreach ($javascriptFiles as $file)
    ...
    @endforeach
    @if ($role == 'superadmin')
        <script src="action-js/dashboard-action.js"></script>
    @elseif ($role == 'penghuni')
        <script src="action-js/dashboard-action.js"></script>
    @elseif ($role == 'penjaga')
        <script src="action-js/property/listkamar-action.js"></script>
    @elseif ($role == 'pemilik')
        <script src="action-js/dashboard-action.js"></script>
    @endif
