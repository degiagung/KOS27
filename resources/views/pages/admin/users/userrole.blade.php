                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="table-list" class="table table-bordered table-striped table-lg table-hover datatables">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Header Name</th>
                            ...
                            <div id="navpills2-2" class="tab-pane">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <table id="table-list-json" class="table table-bordered table-striped table-lg table-hover datatables">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>URL</th>
